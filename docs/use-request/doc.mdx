...
<PropsTable
  data={[
    ...
    { name: "onStatusChange", type: "(status: RequestStatus) => void", nameDetails: "Fires whenever status changes" },
  ]}
/>
...
<PropsTable
  data={[
    ...
    { name: "status", type: "RequestStatus", nameDetails: "Current state: idle | loading | success | error" },
    ...
    { name: "is(status)", type: "(s: RequestStatus) => boolean", nameDetails: "Check the current status" },
