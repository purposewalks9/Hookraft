  ...
  return (
    <footer className="w-full border-t border-border mt-auto">
      <div className="max-w-screen-2xl mx-auto px-6 py-12 md:py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-[1.5fr_1fr_1fr_1fr] gap-10 md:gap-8">
          ...
          <div className="col-span-2 md:col-span-1 flex flex-col gap-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-[220px]">
              Logic hooks for your React views. No UI. No styles. Just clean,
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mt-12 pt-6 border-t border-border">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Hookraft. MIT License.
          </p>
        </div>
