        ...
        <div className="rounded-xl overflow-hidden border border-neutral-800 bg-neutral-950 shadow-2xl">
          ...
          <div className="flex items-center justify-between px-4 py-3 bg-neutral-900 border-b border-neutral-800">
            ...
            <button
              onClick={runCode}
              disabled={isRunning}
              className="flex items-center gap-2 px-3 py-1.5 rounded-md b-white hover:bg-emerald-400 disabled:opacity-60 text-black text-xs font-semibold transition-all"
            >
              {isRunning ? (
