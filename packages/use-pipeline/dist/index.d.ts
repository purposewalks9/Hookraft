type StepStatus = "idle" | "running" | "complete" | "failed" | "skipped" | "rollingback" | "rolledback";
type PipelineStatus = "idle" | "running" | "complete" | "failed" | "rollingback" | "rolledback";
interface PipelineStep<TResult = unknown> {
...
interface UsePipelineOptions<TSteps extends PipelineStep[]> {
...
declare function usePipeline<TSteps extends PipelineStep[]>(options: UsePipelineOptions<TSteps>): UsePipelineReturn;

export { type PipelineContext, type PipelineStatus, type PipelineStep, type PipelineStepState, type StepStatus, type UsePipelineOptions, type UsePipelineReturn, usePipeline };
