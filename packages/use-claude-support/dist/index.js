...
function CloseIcon({ size = 18 }) {
  return /* @__PURE__ */ jsxs("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round", children: [
...
function TypingIndicator({ bg }) {
  return /* @__PURE__ */ jsx("div", { style: { display: "flex", gap: 4, padding: "10px 14px", background: bg, borderRadius: "18px 18px 18px 4px", width: "fit-content", alignItems: "center" }, children: [0, 1, 2].map((i) => /* @__PURE__ */ jsx(
    "span",
    {
      style: {
        width: 7,
