...
interface FieldConfig<T extends FieldValue = string> {
...
interface FieldState<T extends FieldValue = string> {
    /** Current value */
    value: T;
...
interface UseFormOptions<T extends FieldsConfig> {
...
interface UseFormReturn<T extends FieldsConfig> {
...
declare function useForm<T extends FieldsConfig>(options: UseFormOptions<T>): UseFormReturn<T>;

export { type FieldConfig, type FieldRule, type FieldState, type FieldValue, type FieldsConfig, type FormErrors, type FormStatus, type FormValues, type UseFormOptions, type UseFormReturn, useForm };
