...
function ContributionCalendar({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("style", { children: `@keyframes cc-pulse { 0%,100%{opacity:.4} 50%{opacity:.7} }` })
        ]
      }
    );
  }
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        showThemeSwitcher && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", gap: 6, marginBottom: 16, flexWrap: "wrap" }, children: Object.keys(DARK_THEMES).map((t) => {
            ...
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsx("span", { style: {
                  display: "inline-flex",
                  gap: 2
                }, children: [tc.level1, tc.level2, tc.level3, tc.level4].map((c, i) => /* @__PURE__ */ jsxRuntime.jsx("span", { style: {
                  width: 6,
                  height: 6,
                  borderRadius: 1,
                  background: c,
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { style: { overflowX: "auto", overflowY: "visible", WebkitOverflowScrolling: "touch" }, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "inline-flex", gap: showDayLabels ? 6 : 0, paddingBottom: 2 }, children: [
          showDayLabels && /* @__PURE__ */ jsxRuntime.jsx("div", { style: {
            ...
            minWidth: 26,
            flexShrink: 0
          }, children: DAY_LABELS.map((d, i) => /* @__PURE__ */ jsxRuntime.jsx("div", { style: {
            height: blockSize,
            fontSize: 9,
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { position: "relative", marginLeft: showDayLabels ? 8 : 0 }, children: [
            showMonthLabels && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { height: 20, marginBottom: 4, position: "relative", width: gridW }, children: monthLabels.map(({ weekIndex, month }) => /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                style: {
                  position: "absolute",
            ...
            /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", gap: blockGap, width: gridW }, children: filteredWeeks.map((week, wi) => /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", flexDirection: "column", gap: blockGap }, children: week.days.map((day) => {
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 5 }, children: [
            /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 10, color: colors.textMuted }, children: "Less" }),
            [colors.empty, colors.level1, colors.level2, colors.level3, colors.level4].map((c, i) => /* @__PURE__ */ jsxRuntime.jsx("div", { style: {
              width: blockSize,
              height: blockSize,
              borderRadius: Math.max(2, blockSize * 0.2),
              background: c,
            ...
            /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 10, color: colors.textMuted }, children: "More" })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsxs("span", { style: { fontSize: 11, color: colors.text, fontWeight: 600, whiteSpace: "nowrap" }, children: [
            data.totalContributions.toLocaleString(),
            " contributions this year"
          ] })
        ] }),
        tooltip.visible && /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            ref: tooltipRef,
            style: {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontWeight: 600, color: tooltip.count === 0 ? colors.textMuted : colors.level4 }, children: tooltip.count === 0 ? "No contributions" : `${tooltip.count} contribution${tooltip.count !== 1 ? "s" : ""}` }),
              /* @__PURE__ */ jsxRuntime.jsx("span", { style: { color: colors.textMuted }, children: " on " }),
              /* @__PURE__ */ jsxRuntime.jsx("span", { style: { color: colors.text }, children: formatDate(tooltip.date) }),
              /* @__PURE__ */ jsxRuntime.jsx("div", { style: {
                position: "absolute",
                bottom: -5,
                left: "50%",
