      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { position: "relative", marginLeft: showDayLabels ? 8 : 0 }, children: [
            showMonthLabels && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { position: "relative", height: 20, marginBottom: 4, width: gridW }, children: monthLabels.map(({ label, weekIndex }) => /* @__PURE__ */ jsxRuntime.jsx(
              "span",
              {
                style: {
                  position: "absolute",
